...
origin_model_path="/base/model/3D"
...
python transform.py $train_data_dir --model_path "$origin_model_path/$i.pth.tar" --task classification --epochs 45  --wd 0.0005 --lr 0.002  --momentum 0.95 -b 164  \
